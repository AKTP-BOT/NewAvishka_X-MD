...
module.exports = {
  ...
  ANTI_BAD_WORDS: (process.env.ANTI_BAD_WORDS || "pakayo,hutto").split(','),
  ...
  packname: process.env.packname || "KEVIN TECH",
  author: process.env.author || "KEVIN TECH",
  //==========================================- API-CONFIGS -==========================================================
